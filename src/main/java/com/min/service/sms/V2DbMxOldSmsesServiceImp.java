...
import com.min.hbasedao.sms.V2DbMxOldSmsesDaoImp;
...
public class V2DbMxOldSmsesServiceImp implements V2DbMxOldSmsesService {
	...
	@Autowired
	private V2DbMxOldSmsesDaoImp v2DbMxOldSmsesDaoImp;
	
	public V2DbMxBase getV2DbMxBase(String cid) {
		// TODO Auto-generated method stub
		return v2DbMxOldSmsesDaoImp.getV2DbMxBase(cid);
	}

	public List<V2DbMxOldSmses> getV2DbMxOldSmses(String baseinfo_id) {
		// TODO Auto-generated method stub
		return v2DbMxOldSmsesDaoImp.getV2DbMxOldSmses(baseinfo_id);
	}
