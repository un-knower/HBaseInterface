	...
	public List<V2DbMxOldBills> getContacts(String cid) {
		...
		try {
			...
			for (Result res : scanner) {
				...
				v2MxOldB.setBaseinfoId(
						Bytes.toString(res.getValue(Bytes.toBytes(cloum), Bytes.toBytes("BASEINFO_ID"))));
				...
				v2MxOldB.setBillStartDate(
						Bytes.toString(res.getValue(Bytes.toBytes(cloum), Bytes.toBytes("BILL_START_DATE"))));
				v2MxOldB.setBillEndDate(
						Bytes.toString(res.getValue(Bytes.toBytes(cloum), Bytes.toBytes("BILL_END_DATE"))));
				v2MxOldB.setBaseFee(Bytes.toString(res.getValue(Bytes.toBytes(cloum), Bytes.toBytes("BASE_FEE"))));
				v2MxOldB.setExtraServiceFee(
						Bytes.toString(res.getValue(Bytes.toBytes(cloum), Bytes.toBytes("EXTRA_SERVICE_FEE"))));
				...
				v2MxOldB.setExtraDiscount(
						Bytes.toString(res.getValue(Bytes.toBytes(cloum), Bytes.toBytes("EXTRA_DISCOUNT"))));
				...
				v2MxOldB.setRelatedMobiles(
						Bytes.toString(res.getValue(Bytes.toBytes(cloum), Bytes.toBytes("RELATED_MOBILES"))));
